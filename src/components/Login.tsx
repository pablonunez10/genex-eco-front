...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to continue to GenEx Eco</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-green-600 hover:text-green-700 transition duration-200">
                  Forgot password?
                </a>
              </div>
            </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/" className="font-semibold text-green-600 hover:text-green-700 transition duration-200">
              Sign up here
            </Link>
          </p>
        </div>

...
export function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* User Menu y Carrito a la derecha */}
              ...
              {isAuthenticated ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 p-2 text-gray-700 hover:text-green-600 transition-colors duration-200 rounded-lg hover:bg-green-50"
                  >
                ...
                <Link
                  to="/login"
                  className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-green-600 transition-colors duration-200 rounded-lg hover:bg-green-50"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
      ...
      {isCartOpen && (
        <div className="fixed inset-y-0 right-0 w-[300px] bg-white shadow-xl z-50 animate-slide-in-right border-l border-gray-200">
